...
\projectinfo{
  ...
  title.cs={Detekce, lokalizace a určení plochy hematomů},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Detection, Localization and Determination of Hematoma Area}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
...
\begin{document}
  ...
  % ----------------------------------------------
  \input{obsah} % viz. obsah.tex / see obsah.tex
...
\fi
  ...
  \iftwoside
    \cleardoublepage
  \fi
  \input{prilohy} % viz. prilohy.tex / see prilohy.tex
\end{document}
